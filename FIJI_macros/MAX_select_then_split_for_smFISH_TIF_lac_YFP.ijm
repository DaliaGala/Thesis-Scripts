...
outputCSV = getDirectory("Choose Destination Directory for csvs ");
...
for (i=0; i<list.length; i++) {
	...
	if (endsWith(list[i], ".tif")) {
		...
		redirectImageTitle = "MAX_C2-" + fileName + "-1.tif";
...
saveAs("Results", outputCSV + "Results_Area" + fileName + ".csv");
close("Results");
}
